...
# with command line options: ZZ/Gen/sherpa_fZ_m0p060_m0p060_cff.py -s GEN --conditions MC_41_v0::All --datatier GEN-SIM-RAW --eventcontent RAWSIM -n 100 --no_exec --fileout Sherpa_Gen.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('ZZ/Gen/sherpa_fZ_m0p060_m0p060_cff.py nevts:100'),
