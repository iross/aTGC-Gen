...
# with command line options: step2 -s RAW2DIGI,RECO --conditions MC_41_V0::All --datatier GEN-SIM-RECO --eventcontent RECOSIM -n 100 --no_exec --filein file:outputGENDIGIHLT.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/hdfs/store/user/iross/Sherpa_ZZ_0p0_0p0/Sherpa_Gen_89_1_vzj.root')
)
